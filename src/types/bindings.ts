export type AppBindings = {
  ...
  Bindings: {
    ...
    CONTEXTKIT_RATE_LIMIT_PER_MINUTE?: string;
    CONTEXTKIT_GLOBAL_RATE_LIMIT_PER_MINUTE?: string;
    CONTEXTKIT_MAX_CONCURRENT_REQUESTS?: string;
    CONTEXTKIT_MAX_CONCURRENT_REQUESTS_PER_CLIENT?: string;
    CONTEXTKIT_MARKETPLACE_BETA_MODE?: string;
    CONTEXTKIT_BETA_SELLERS?: string;
  };
};
