      ...
      <div className="relative mx-auto max-w-7xl">
        <section className="contact-hero overflow-hidden rounded-[1.75rem] border border-white/[0.14]">
          ...
          <div className="grid lg:grid-cols-[1.15fr_0.85fr]">
            <div className="p-7 sm:p-10 lg:p-14"><p className="font-mono text-[11px] uppercase tracking-[0.2em] text-mint">Contact the developer</p><h1 className="contact-title mt-6 max-w-4xl text-balance text-6xl font-semibold leading-[0.82] tracking-[-0.085em] text-white sm:text-7xl lg:text-[7rem]">Build agents<br /><span className="text-mint">that remember.</span></h1><p className="mt-9 max-w-xl text-lg leading-8 text-white/65">I build sharp infrastructure for autonomous systems: x402 payments, durable context, evidence-backed skill registries, and agent workflows that keep moving when the conversation ends.</p><div className="mt-10 flex flex-wrap gap-x-6 gap-y-3 font-mono text-[10px] uppercase tracking-[0.17em] text-white/45"><span>Independent builder</span><span className="text-mint">ContextKit founder</span><span>Bankr native</span></div></div>
          ...
          <div className="contact-ticker border-t border-white/10 py-3 font-mono text-[10px] uppercase tracking-[0.28em] text-white/45"><div className="contact-ticker-track"><span>agent memory</span><span>verified skills</span><span>x402 payments</span><span>context architecture</span><span>agent memory</span><span>verified skills</span><span>x402 payments</span><span>context architecture</span></div></div>
        </section>
