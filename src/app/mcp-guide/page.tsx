        ...
        <section className="mt-16">
          ...
          <div className="mt-5 grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
            <article className="rounded-[1.3rem] border border-mint/20 bg-mint/[0.045] p-6 sm:p-7">
              ...
              <p className="mt-5 text-sm leading-7 text-white/62">The bridge reads the latest completed task, strips credentials locally, ignores failed, trivial, generic, and duplicate runs, then compiles qualifying Bankr-adjacent work into a portable SKILL.md. Private write requires a complete reusable workflow and one transcript-grounded hard-evidence PASS. Public listing requires three distinct grounded PASS excerpts, score 75+, approved ecosystem, verification, rollback, safety boundaries, and no private paths or identifiers.</p>
            </article>
