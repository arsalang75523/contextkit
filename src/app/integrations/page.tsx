          ...
          {integrationGuides.map((guide) => (
            <article key={guide} className="rounded-md border border-line bg-white/[0.035] p-6">
              ...
              <p className="mt-3 leading-7 text-white/62">
                Add ContextKit as a context lifecycle and verified-skill tool: preserve continuation state, then compile completed reusable work from any legitimate domain with source-grounded execution proof. Publishing always remains approval-gated.
              </p>
              <div className="mt-5">
                <CodeBlock
                  code={
