...
const memoryNodes = [
  ["01", "Goal", "wait time <18 min", "mint"],
  ["02", "Constraint", "8-vehicle depot", "aqua"],
  ["03", "Decision", "daytime routes fixed", "amber"],
  ["04", "Next", "charger rotation", "coral"]
] as const;
    ...
    <main className="overflow-hidden">
      <section className="agent-hero relative isolate min-h-[calc(100vh-62px)] px-5 pb-8 pt-6 md:pt-8">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[0.93fr_1.07fr] lg:gap-12">
                ...
                <div className="grid gap-0 border-b border-line md:grid-cols-[0.88fr_1.12fr]">
                  <div className="relative min-h-[220px] overflow-hidden border-b border-line p-4 md:border-b-0 md:border-r">
                    <div className="relative flex h-full flex-col">
                      <div className="flex items-center justify-between font-mono text-[10px] uppercase tracking-[0.16em] text-white/42"><span>Active context</span><span className="text-mint">ck_7f91e2</span></div>
                      <div className="mt-4 space-y-2.5 font-mono text-[11px]">
                        <ContextLine label="MODE" value="compact / continuation" tone="text-mint" />
                        <ContextLine label="SOURCE" value="x402 / paid request" tone="text-aqua" />
                        <ContextLine label="GOAL" value="reduce wait time below 18m" tone="text-white/78" />
                        <ContextLine label="RISK" value="charging capacity: 8 vehicles" tone="text-coral" />
